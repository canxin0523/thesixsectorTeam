...
public class MenuController extends BaseController {
    ...
    public void addMenu(@Valid Menu menu) throws SixsectorException {
        try {
    ...
    public void deleteMenus(@NotBlank(message = "{required}") @PathVariable String menuIds) throws SixsectorException {
        try {
    ...
    public void updateMenu(@Valid Menu menu) throws SixsectorException {
        try {
    ...
    public void export(Menu menu, HttpServletResponse response) throws SixsectorException {
        try {
