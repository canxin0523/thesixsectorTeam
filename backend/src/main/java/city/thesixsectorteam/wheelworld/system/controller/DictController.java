...
public class DictController extends BaseController {
    ...
    public void addDict(@Valid Dict dict) throws SixsectorException {
        try {
    ...
    public void deleteDicts(@NotBlank(message = "{required}") @PathVariable String dictIds) throws SixsectorException {
        try {
    ...
    public void updateDict(@Valid Dict dict) throws SixsectorException {
        try {
    ...
    public void export(QueryRequest request, Dict dict, HttpServletResponse response) throws SixsectorException {
        try {
