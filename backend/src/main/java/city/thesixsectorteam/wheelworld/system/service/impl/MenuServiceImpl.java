...
import city.thesixsectorteam.wheelworld.common.domain.Tree;
import city.thesixsectorteam.wheelworld.common.utils.TreeUtil;
import city.thesixsectorteam.wheelworld.system.dao.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public Map<String, Object> findMenus(Menu menu) {
        ...
        try {
            ...
            result.put("ids", ids);
            if (StringUtils.equals(menu.getType(), SixsectorConstant.TYPE_BUTTON)) {
