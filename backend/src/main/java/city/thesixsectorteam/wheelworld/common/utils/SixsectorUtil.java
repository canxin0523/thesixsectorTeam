...
import city.thesixsectorteam.wheelworld.common.function.CacheSelector;
...
public class SixsectorUtil {
    ...
    public static String encryptToken(String token) {
        try {
            EncryptUtil encryptUtil = new EncryptUtil(SixsectorConstant.TOKEN_CACHE_PREFIX);
